...
/** Палитра для колонок без явного ключевого слова — каждая строка статуса стабильно получает свой цвет */
...
/** Цвет кружка статуса в списке «Мои запросы» по названию колонки доски */
